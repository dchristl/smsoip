<?php
	...
	<div id="container">
    	<div id="header">
<h1><a href="./"><img src="smsoip.png" alt="Logo"> Translating to ' . $langname . ' (' . $lang . ')</a></h1></div></div>';include('../includes/menu.php');echo '<div id="body"> <div id="content"><div class="box">';
